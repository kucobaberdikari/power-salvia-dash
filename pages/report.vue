          ...
          <table class="items-center w-full mb-2 align-top border-collapse text-slate-500" >
            <thead class="align-bottom">
              <tr>
                ...
                <th class="px-6 py-3 font-bold text-left uppercase align-middle bg-transparent border-b border-collapse shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-700">Telepon</th>
            ...
            <tbody v-else>
             <tr v-for="c in perawatan" :key="c.id" class="pb-2">
              ...
              <td class="p-2 align-middle bg-transparent border-b  whitespace-nowrap shadow-transparent">
                <button class="text-md font-semibold leading-tight py-2 px-2 rounded-l-lg w-16 text-blue-button-light hover:bg-blue-button-light hover:text-white"> Edit </button>
                <button @click="onToggle" class="text-md font-semibold leading-tight py-2 px-2 w-16 text-green-button-light hover:bg-green-button-light hover:text-white"> Detail </button>
                <button class="text-md font-semibold leading-tight py-2 px-2 rounded-r-lg w-16 text-red-500 hover:bg-red-button hover:text-white"> Delete </button>
              </td>
             </tr>
            </tbody>
          </table>
...
const {pending, data:perawatan} = await useLazyFetch("http://127.0.0.1:8000/api/perawatan", {
