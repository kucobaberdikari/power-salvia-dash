...
<template>
  <div class="flex flex-col flex-wrap sm:flex-row lg:mb-4">
    <div class="w-full sm:w-1/2 xl:w-1/3">
      <div class="mb-4">
        <div class="w-full rounded-2xl bg-venice-blue p-4 shadow-lg">
          <div class="mb-6 flex items-center justify-between">
            <div class="flex items-center">
              <span class="relative rounded-xl bg-white p-2">
                <svg
                  width="25"
                  height="25"
                  viewBox="0 0 256 262"
              ...
              <div class="flex flex-col">
                ...
                <span class="ml-2 text-sm text-gray-500">Google Inc.</span>
              </div>
            </div>
            <div class="flex items-center">
              <button class="rounded-full border border-gray-200 p-1">
                <svg
                  ...
                  width="20"
                  height="20"
                  class="h-4 w-4 text-yellow-button-light"
                  fill="currentColor"
          ...
          <div class="mb-4 flex items-center justify-between space-x-12">
            <span
              class="flex items-center rounded-md bg-gray-200 px-2 py-1 text-xs font-semibold text-blue-button-light"
            >
              PROGRESS
            </span>
            <span
              class="flex items-center rounded-md border border-red-400 bg-white px-2 py-1 text-xs font-semibold text-red-400"
            >
              HIGH PRIORITY
            </span>
          </div>
          <div class="m-auto block">
            <div>
              <span class="inline-block text-sm text-gray-500">
                Task done :<span class="font-bold text-gray-700">25</span>
                /50
              </span>
            </div>
            <div class="mt-2 h-2 w-full rounded-full bg-gray-200">
              <div
                class="h-full w-1/2 rounded-full bg-blue-button-light text-center text-xs text-white"
              />
            </div>
          </div>
          <div class="my-4 flex items-center justify-start space-x-4">
            <span
              class="flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-semibold text-green-500"
            >
              IOS APP
            </span>
            <span
              class="flex items-center rounded-md bg-blue-100 px-2 py-1 text-xs font-semibold text-blue-500"
            >
              UI/UX
            </span>
          </div>
          ...
          <span
            class="mt-4 flex w-36 items-center rounded-md bg-yellow-100 px-2 py-1 text-xs font-semibold text-yellow-500"
          >
            DUE DATE : 18 JUN
          </span>
        </div>
        ...
        <div class="w-full rounded-2xl bg-white p-4 shadow-lg">
          <div class="mb-6 flex items-center justify-between">
            <div class="flex items-center">
              ...
              <div class="flex flex-col">
                <span class="ml-2 font-bold text-black">Slack</span>
          ...
          <div class="mb-4 flex items-center justify-between space-x-12">
            ...
            <span
              class="flex items-center rounded-md border border-yellow-500 bg-white px-2 py-1 text-xs font-semibold text-yellow-500"
            >
              MEDIUM PRIORITY
            </span>
          </div>
          <div class="m-auto block">
            <div>
              <span class="inline-block text-sm text-gray-500">
                Task done :<span class="font-bold text-gray-700">50</span>
                /50
              </span>
            </div>
            <div class="mt-2 h-2 w-full rounded-full bg-gray-200">
              <div
                class="h-full w-full rounded-full bg-green-button-light text-center text-xs text-white"
              />
            </div>
          </div>
          <div class="my-4 flex items-center justify-start space-x-4">
            ...
            <span
              class="flex items-center rounded-md bg-yellow-200 px-2 py-1 text-xs font-semibold text-yellow-600"
            >
              ANDROID
            </span>
          </div>
    ...
    <div class="w-full sm:w-1/2 xl:w-1/3">
      <div class="mx-0 mb-4 sm:ml-4 xl:mr-4">
        <div class="w-full rounded-2xl bg-white shadow-lg">
          <p class="p-4 font-bold text-black">
            My Tasks
            <span class="ml-2 text-sm text-gray-500">(05)</span>
          </p>
          <ul>
            <li
              class="flex items-center justify-between border-b-2 border-gray-100 py-3 text-gray-600"
            >
            ...
            >
              <div class="flex items-center justify-start text-sm">
                ...
                <span class="ml-2 flex items-center text-gray-400 lg:ml-6">
                  3
                  <svg
                    width="15"
                    height="15"
            ...
            <li
              class="flex items-center justify-between border-b-2 border-gray-100 py-3 text-gray-400"
            >
              <div class="flex items-center justify-start text-sm">
            ...
            <li class="flex items-center justify-between py-3 text-gray-600">
              <div class="flex items-center justify-start text-sm">
      ...
      <div class="mb-4 sm:ml-4 xl:mr-4">
        <div class="w-full rounded-2xl bg-white shadow-lg">
          <div class="flex items-center justify-between p-4">
            <p class="font-bold text-black">Google</p>
            <button
              class="mr-4 rounded border border-gray-400 p-1 text-sm text-gray-400"
            >
              <svg
                width="15"
                height="15"
          ...
          <div
            class="flex items-center justify-between border-l-4 border-blue-500 bg-blue-100 px-4 py-2 text-gray-600"
          >
            ...
            <div class="flex items-center">
              <span class="mx-2 text-xs font-bold md:ml-4">25 min 20s</span>
              <button
                class="mr-4 rounded border bg-blue-500 p-1 text-sm text-gray-400"
              >
                <svg
                  width="17"
                  height="17"
          ...
          <div
            class="flex items-center justify-between border-b-2 border-gray-100 p-4"
          >
            <p class="font-bold text-black">Slack</p>
            <button
              class="mr-4 rounded border border-gray-400 p-1 text-sm text-gray-400"
            >
              <svg
          ...
          <div
            class="flex items-center justify-between border-b-2 border-gray-100 px-4 py-2 text-gray-600"
          >
            <p class="flex items-center text-xs">
              <svg
                width="20"
            ...
            <div class="flex items-center">
              <span class="mx-2 text-xs text-gray-400 md:ml-4">30 min</span>
              <button
                class="mr-4 rounded border border-gray-400 p-1 text-sm text-gray-400"
              >
                <svg
          ...
          <div
            class="flex items-center justify-between px-4 py-2 text-gray-600"
          >
            <p class="flex items-center text-xs">
              <svg
                width="20"
    ...
    <div class="w-full sm:w-1/2 xl:w-1/3">
      <div class="mb-4">
        <div class="w-full rounded-2xl bg-white p-4 shadow-lg">
          <p class="font-bold text-black">Messages</p>
          <ul>
