...
<template>
  <div class="flex flex-col flex-wrap sm:flex-row mb-20">
    <div class="w-full pl-2">

      <div class="mb-8">
        <div class="flex  justify-between gap-6 sm:items-center sm:flex-row">
          <div >
          ...
          <button @click="onToggle" class="w-36 h-12 mr-2 rounded-full bg-blue-button-light text-white text-lg font-medium hover:drop-shadow-lg hover:shadow-purple-progress">New Role</button>
        </div>
      </div>
  ...
  <transition name="fade" class=" sm:-mt-96 block min-h-screen">
    <div v-if="isModalVisible" >
      ...
      <div
        class="w-full max-w-lg p-3 -mt-96 relative mx-auto my-auto rounded-xl shadow-lg bg-white"
      >
